...
## Data Source
The dataset was obtained from kaggle. It includes information such as:
- Company name
...
- Build time series charts of layoffs over time
- Identify companies with the largest workforce reductions
